...
public class ApplicationContainer extends AbstractComponent implements AdmissionNotificationHandlerI {
	...
	public ApplicationContainer(String uri, Admission admission, String AdmissionNotificationInboundPortURI,
		...
		rg = new RequestGenerator(APP_URI + "rg", // generator component URI
