 ...
 *
 */
public class ApplicationContainerCooperation 
	...
	public ApplicationContainerCooperation(String uri, AbstractCVM cvm, AdmissionI admission,
		...
		this.rg = new RequestGenerator(APP_URI + "RG", // generator component URI
				570.0, 			// mean time between two requests
...
//		this.rg.DEBUG_LEVEL = 2;
	...
	public void startAsync() throws Exception {
		final ApplicationContainerCooperation application = this;
